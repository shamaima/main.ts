...
let guestArr : string[] = ["ali","hassan","zareen","alishba"];
...
// part 2 began
let guestBeg : string ="anabia"
guestArr .unshift(guestBeg);
console.log(guestArr)

//part 3 middle
let middleGuest : string = "mehak"
...
let invitation: string [] = ["ali", "hamza"]
...
//  let country: String[] = ["pakistan","england","america","iraq","japan"]
 ...
 let person: {name: string, fname: string , age : number} ={name:"shamaima",fname:"female", age:18}
 console.log(person)
...
let name_1: string = "shamaima"
let name_2: string = "shamaima hassan"
let name_3: string = " miss shamaima hassan"
